...
In questa sezione descriviamo il protocollo in generale, senza entrare nei dettagli con cui ciascun modello viene eseguito.
...
\begin{itemize}
  ...
  \item \textbf{StyleMix}: circa 16.800 immagini provenienti dal catalogo StyleMix, inizialmente prive di annotazioni, etichettate automaticamente tramite SAM3 con la procedura descritta
        nel capitolo dedicato. Una sola esecuzione di SAM3 ha prodotto sia il dataset di detection che quello di segmentazione, e le immagini della ground truth sono state escluse per evitare sovrapposizioni con il test.
\end{itemize}

\noindent
Dei modelli proposti, ad eccezione di SAM3, usato senza addestramento, e del black box, tutti i modelli riportati nei grafici sono addestrati sul dataset StyleMix. Fa eccezione SegF\_HF, che condivide l'architettura con SegF\_StyleMix ma è addestrato sul dataset HF:
il confronto tra i due permette quindi di osservare l'effetto del dataset a parità di modello.
...
\noindent
Per ogni immagine viene inoltre salvata un'anteprima con maschere e box sovrapposti, utile a verificare visivamente la qualità delle annotazioni,
dove le immagini in cui non viene rilevato alcun capo vengono escluse.
...
\begin{figure}[htbp]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{images/stats/comparison_YOLO_det.png}}
...
\begin{figure}[htbp]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{images/stats/comparison_YOLO_seg.png}}
...
\begin{figure}[htbp]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{images/stats/comparison_SegFormer.png}}
...
\begin{figure}[htbp]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{images/stats/comparison_GroundingDino.png}}
...
\begin{figure}[htbp]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{images/stats/comparison_SAM3_vs_best.png}}
